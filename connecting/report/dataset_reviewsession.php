...
print_r($tutorial_student_response[$this_course][$tutorial_for_concept][$this_user][$this_date_viewed]['response'][$part]);
...
foreach ($quiz_scores as $this_course => $val_user) {
  foreach ($val_user as $this_user => $val_cb) {
    foreach ($val_cb as $this_concept => $data) {
      ...
      if (is_valid_user($this_user) AND !(preg_match("/tcerroc/", $this_concept))) {
        if ((array_key_exists('pre', $data) && ($data['pre']['percent'] == 1)) || (array_key_exists($this_user, $practice[$this_course]) && !array_key_exists($no_group_cb, $practice[$this_course][$this_user]))) {
          $r++;
          ...
          else {  print "<TD></TD><TD></TD><TD></TD><TD></TD>"; }
          ...
          if (array_key_exists('post', $data)) {
            ...
            if ($data['pre']['percent'] == 1) {
              print "<TD>Not Assigned</TD><TD>Not Assigned</TD><TD>Not Assigned</TD><TD>Not Assigned</TD>";
            }
            else {
          ...
          if (array_key_exists('pre', $data)) {
            ...
            $sheet->write($r,3, 'No Attempt');
            $sheet->write($r,4, 'No Attempt');
            $sheet->write($r,5, 'No Attempt');
            $sheet->write($r,6, 'No Attempt');
          }
    ...
    foreach ($val_cb as $this_concept_bank => $val_date) {
      ...
      foreach ($val_date as $this_date => $data) {
        if (($this_date != 'total_incorrect_attempts') && (is_valid_user($this_user))) {
          ...
          print "<TR><TD>$this_course</TD>";
          print "<TD>" . clean_data($this_user) . "</TD>";
          print "<TD>$this_concept_bank</TD>";
          if (array_key_exists('pre', $quiz_scores[$this_course][$this_user][$group_cb]) && array_key_exists('attempted', $quiz_scores[$this_course][$this_user][$group_cb]['pre'])) {
          ...
          else { print "<TD>Not Attempted</TD><TD>Not Attempted</TD><TD>Not Attempted</TD><TD>Not Attempted</TD>"; }
          if (array_key_exists('post', $quiz_scores[$this_course][$this_user][$group_cb]) && array_key_exists('attempted', $quiz_scores[$this_course][$this_user][$group_cb]['post'])) {
          ...
          if (array_key_exists($this_course, $tutorial_student_response) && array_key_exists($this_concept_bank, $tutorial_student_response[$this_course]) && array_key_exists($this_user, $tutorial_student_response[$this_course][$this_concept_bank])) {
            foreach ($tutorial_student_response[$this_course][$this_concept_bank][$this_user] as $this_date_viewed => $tut_viewing_data) {
              if ($this_date_viewed >= $this_date) {
                ...
                print "<TD></TD>";
                print "<TD>";
                print array_key_exists($this_concept_bank, $tutorial_available_for_concept_bank) ? "Tutorial Exists Not Yet Triggered" : "Tutorial DNE Not Yet Triggered";
                print "</TD>";
                ...
                print "<TD>";
                print $tut_viewing_data['response']['parts_viewed'] == $tutorial_tree[$tutorial_id]['prompt_parts'] ? "Tutorial Exists Full Viewing" : "Tutorial Exists Partial Viewing";
                print "</TD>";
            ...
            if ($this_course == "Math160_F2009_awangberg") {
              if ($incorrect_attempts_at_concept >= 4) {
                print array_key_exists($this_concept_bank, $tutorial_available_for_concept_bank) ? "Tutorial EIF should have been viewed" : "Tutorial DNE should have been viewed";
                ...
                if ($total_incorrect_attempts_at_concept >= 4) {
                  print array_key_exists($this_concept_bank, $tutorial_available_for_concept_bank) ? "Tutorial EIF not yet triggered" : "Tutorial DNE not yet triggered";
                  $sheet->write($r, 31, array_key_exists($this_concept_bank, $tutorial_avaiable_for_concept_bank) ? "Tutorial EIF not yet triggered" : "Tutorial DNE not yet triggered");
                }
                else {
                  print array_key_exists($this_concept_bank, $tutorial_available_for_concept_bank) ? "Tutorial EIF would not be triggered" : "Tutorial DNE would not be triggered";
              ...
              if ($incorrect_attempts_at_concept >= 4) {
                print array_key_exists($this_concept_bank, $tutorial_available_for_concept_bank) ? "Tutorial NA should have been viewed" : "Tutorial DNE should have been viewed";
                ...
                if ($total_incorrect_attempts_at_concept >= 4) {
                  print array_key_exists($this_concept_bank, $tutorial_available_for_concept_bank) ? "Tutorial NA not yet triggered" : "Tutorial DNE not yet triggered";
                  ...
                  print array_key_exists($this_concept_bank, $tutorial_available_for_concept_bank) ? "Tutorial NA would not be triggered" : "Tutorial DNE would not be triggered";
            ...
            else if ($this_course == "Math160_S2010_awangberg_05") {
              print array_key_exists($this_concept_bank, $tutorial_available_for_concept_bank) ? "Tutorial Exists would not be triggered" : "Tutorial DNE would not be triggered";
...
print_r($tutorial_tree[$tutorial_id]['prompt_id']);
...
print_r($data);
              ...
              if ($data['response'][$i]['askForReason'] == "N") {
                ...
                $tut_sheet->write($r, 20, "No Reason Requested");
              }
                ...
                $tut_sheet->write($r, 20, is_numeric($data['response'][$i]['to_submit_reason']) ? round($data['response'][$i]['to_submit_reason']/1000, 3) : "No Reason Given");
              }
